...
using ApiOcorrencia.Infra.Repository.Repositories;
...
namespace ApiOcorrencia.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IServiceOcorrencia, ServiceOcorrencia>();

            services.AddScoped<IRepositoryOcorrencia, RepositoryOcorrencia>();
